...
export function whenAny<TRet, T1, T2>(
  arg1: ObservableLike<T1>, arg2: ObservableLike<T2>,
  selector: (
    arg1: T1, arg2: T2,
  ) => TRet,
): Observable<TRet>;
...
export function whenAny<TRet, T1, T2, T3, T4>(
  arg1: ObservableLike<T1>, arg2: ObservableLike<T2>,
  arg3: ObservableLike<T3>, arg4: ObservableLike<T4>,
  selector: (
...
export function whenAny<TRet, T1, T2, T3, T4, T5, T6>(
  arg1: ObservableLike<T1>, arg2: ObservableLike<T2>,
  arg3: ObservableLike<T3>, arg4: ObservableLike<T4>,
  arg5: ObservableLike<T5>, arg6: ObservableLike<T6>,
  selector: (
...
export function whenAny<TRet, T1, T2, T3, T4, T5, T6, T7, T8>(
  ...
  arg3: ObservableLike<T3>, arg4: ObservableLike<T4>,
  arg5: ObservableLike<T5>, arg6: ObservableLike<T6>,
  arg7: ObservableLike<T7>, arg8: ObservableLike<T8>,
  selector: (
...
export function whenAny<TRet, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
  ...
  arg5: ObservableLike<T5>, arg6: ObservableLike<T6>,
  arg7: ObservableLike<T7>, arg8: ObservableLike<T8>,
  arg9: ObservableLike<T9>, arg10: ObservableLike<T10>,
  selector: (
