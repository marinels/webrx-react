...
declare module 'ix/iterable/concat' {
  ...
  function concat<T>(source: IterableX<T>, ...args: Array<Iterable<T>>): IterableX<T>;
}

declare module 'ix/asynciterable/concat' {
  // @ts-ignore: static function overload augmentation
  function concat<T>(source: AsyncIterableX<T>, ...args: Array<AsyncIterable<T>>): AsyncIterableX<T>;
}

declare module 'ix/asynciterable/merge' {
  // @ts-ignore: static function overload augmentation
  function merge<T>(source: AsyncIterableX<T>, ...args: Array<AsyncIterable<T>>): AsyncIterableX<T>;
}
