  ...
  return (
    <Components.NavButton href="#">
      <Components.CommandButton
        ...
        style={{ padding: 5 }}
        onClick={() =>
          Alert.create(JSON.stringify(x, undefined, 2), 'Element Clicked')
        }
      >
...
export const demoViewMap: ViewActivatorMap = {
  ...
  SizedLoading: (c, cr) =>
    Components.Loading.renderSizedLoadable(true, '50px Loader...', 50),
  Splash: () => (
    <Components.Splash
      fluid
      header="webrx-react Demo"
      logo="http://placehold.it/100x100?text=Logo"
    />
  ),
  CommandButton: () => (
    <FormGroup bsSize="large" style={{ marginBottom: 0 }}>
      <InputGroup>
        <FormControl
          id="CommandButtonParamInput"
          type="text"
          placeholder="Enter Command Parameter Text Here..."
        />
        <InputGroup.Button>
          <Components.CommandButton
            id="demo-cmd-btn-1"
            bsSize="large"
            commandParameter={() =>
              ((document.getElementById('CommandButtonParamInput') ||
                {}) as HTMLInputElement).value
            }
            command={Components.CommandButton.wx.command(x =>
              Alert.create(x, 'CommandButton Pressed'),
            )}
          ...
          <Components.CommandButton
            ...
            tooltip={
              <Popover id="cmd-btn-custom-tt" placement="top">
                Custom Tooltip
              </Popover>
            }
          >
  ...
  Alert: () => (
    <div>
      <Button
        onClick={() =>
          Alert.create(`Alert Content: ${new Date()}`, 'Info Alert', 'info')
        }
      >
        Info Alert
      </Button>
      <Button
        onClick={() =>
          Alert.createForError(
            new Error(`Error Message: ${new Date()}`),
            'Error Alert',
          )
        }
      >
    ...
    <div>
      ...
      <Components.TimeSpanInput>
        <FormControl
          type="text"
          id="custom"
          placeholder="You can also use your own custom control component"
        />
      </Components.TimeSpanInput>
    </div>
  ),
  ...
  ContextMenu: () => (
    <div>
      ...
      >
        ...
        <MenuItem title="Item 1 Tooltip" href="#/demo/ContextMenu?clicked=1">
          Item 1
        </MenuItem>
        <MenuItem title="#/demo/ContextMenu" eventKey={{ val: 1 }}>
          Item 2
        </MenuItem>
        <MenuItem divider />
      ...
      <div>
        <div>
          ...
          <Components.ProfilePicture
            ...
            rounded
            size={40}
            title="Rounded Fixed Width/Height Icon"
          />
        </div>
        <div>
          <Components.ProfilePicture
          ...
          <Components.ProfilePicture
            ...
            thumbnail
            size={40}
            title="Fixed Width/Height Image"
          />
          <Components.ProfilePicture
            style={style}
            src={imageData}
            ...
            rounded
            size={40}
            title="Rounded Fixed Width/Height Image"
          />
        </div>
        <div>
          <Components.ProfilePicture
            style={style}
            src="http://via.placeholder.com/50x30"
            title="Wide Image"
          />
          <Components.ProfilePicture
            style={style}
            src="http://via.placeholder.com/30x50"
            title="Tall Image"
          />
          <Components.ProfilePicture
            style={style}
            src="http://via.placeholder.com/100x60"
            title="X-Wide Image"
          />
          <Components.ProfilePicture
            style={style}
            src="http://via.placeholder.com/60x100"
            title="X-Tall Image"
          />
        </div>
        <div style={{ height: 250 }}>
          <Components.ProfilePicture
            ...
            thumbnail
            responsive
            title="Responsive Thumbnail Image"
          />
          <Components.ProfilePicture
            style={style}
            src={imageData}
            ...
            rounded
            responsive
            title="Responsive Rounded Thumbnail Image"
          />
        </div>
      </div>
    );
  ...
  GridPanel: () => (
    <Components.Grid border style={{ height: 400 }}>
      ...
      <Components.Grid.Columns
        itemClassName={ctx => `Col-${ctx.column}`}
      ...
      <div data-grid-row={0} data-grid-column={0}>
        (0, 0): [ 200px width, 100px height ]
      </div>
      <div data-grid-row={0} data-grid-column={1}>
        (1, 0): [ 2x stretch width, 100px height ]
      </div>
      <div data-grid-row={0} data-grid-column={2}>
        (2, 0): [ 1x stretch width, 100px height ]
      </div>
      <div data-grid-row={1} data-grid-column={0}>
        (0, 1): [ 200px width, 200px height ]
      </div>
      <div data-grid-row={1} data-grid-column={1}>
        (1, 1): [ 2x stretch width, 200px height ]
      </div>
      <div data-grid-row={1} data-grid-column={2}>
        (2, 1): [ 1x stretch width, 200px height ]
      </div>
      <div data-grid-row={2} data-grid-column={0}>
        (0, 2): [ 200px width, 1x stretch height ]
      </div>
      <div data-grid-row={2} data-grid-column={1}>
        (1, 2): [ 2x stretch width, 1x stretch height ]
      </div>
      <div data-grid-row={2} data-grid-column={2}>
    ...
    return (
      <Grid fluid>
        <Row>
          ...
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-2"
              className="content-tt-2"
              content="Just Text"
              placement="top"
            >
        ...
        <Row>
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-5"
              content={
                <Tooltip id="content-tt-5t" children="Tooltip Component" />
              }
            >
          ...
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-6"
              className="content-tt-6"
              content={
                <Tooltip id="content-tt-6t" children="Tooltip Component" />
              }
              placement="top"
            >
          ...
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-7"
              content={
                <Tooltip id="content-tt-7t" children="Tooltip Component" />
              }
              popover
            >
          ...
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-8"
              content={
                <Tooltip id="content-tt-8t" children="Tooltip Component" />
              }
              title="Popover Mode"
            >
        ...
        <Row>
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-9"
              content={
                <Popover id="content-tt-9p" children="Popover Component" />
              }
            >
          ...
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-10"
              className="content-tt-10"
              content={
                <Popover id="content-tt-10p" children="Popover Component" />
              }
              placement="top"
            >
          ...
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-11"
              content={
                <Popover id="content-tt-11p" children="Popover Component" />
              }
              popover
            >
          ...
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-12"
              content={
                <Popover id="content-tt-12p" children="Popover Component" />
              }
              title="Popover Mode"
            >
        ...
        <Row>
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-13"
              className="content-tt-13t"
              content={
                <Tooltip
                  id="content-tt-13t"
          ...
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-14"
              className="content-tt-14p"
              content={
                <Popover
                  id="content-tt-14p"
          ...
          <Col md={3}>
            <Components.ContentTooltip
              id="demo-content-tooltip-15"
              className="content-tt-15"
              content={
                <OverlayTrigger
                  overlay={
                    <Tooltip
                      id="content-tt-15t"
                      className="content-tt-15t"
                      children="Tooltip Component"
                      placement="top"
                    />
                  }
  ...
  NavButton: () => {
    return (
      <div>
        ...
        <Components.NavButton href="#">testing</Components.NavButton>
        <Components.NavButton href="#">
          <div>
            <Label>Item 1</Label>
          </div>
  ...
  ItemsViewModel: (
    viewModel: Components.ItemsViewModel<{}>,
        ...
        return (
          <Components.ItemsView
            ...
            itemTemplate={(x: SampleData, i: number) => {
              ...
              return (
                <div key={i} data-grid-row={row} data-grid-column={col}>
                  {x.name}
                </div>
              );
            }}
  ...
  ListItemsViewModel: (
    viewModel: Components.ListItemsViewModel<{}>,
    componentRoute: string,
  ) => {
    const a: React.ReactElement<Components.ListGroupPanelProps> = (
      <Components.ListGroupPanel />
    );
    switch (componentRoute) {
      case 'ListItemsDefault':
        return <Components.ListItemsView viewModel={viewModel} />;
        ...
        return (
          ...
          >
            <Components.ListGroupView
              fill
              itemsProps={{ itemStyle: { textAlign: 'right' } }}
            />
          </Components.ListItemsView>
        );
      case 'ListItemsPanel':
      ...
      case 'ListItemsGrid':
        return (
          <Components.ListItemsView viewModel={viewModel}>
            <Components.GridView>
              <Components.GridViewColumn
                header="Id"
                cellTemplate={(x: SampleData) => x.id}
              />
              <Components.GridViewColumn
                header="Category"
                cellTemplate={(x: SampleData) => x.cat}
              />
              <Components.GridViewColumn
                header="Name"
                cellTemplate={(x: SampleData) => x.name}
              />
              <Components.GridViewColumn
                header="Required By"
                cellTemplate={(x: SampleData) => <div>{x.requiredBy}</div>}
              />
            </Components.GridView>
          </Components.ListItemsView>
        );
  ...
  TreeListItemsViewModel: (
    viewModel: Components.TreeListItemsViewModel<{}>,
    componentRoute: string,
  ) => {
    return (
      <Components.ListItemsView
  ...
  ModalDialogViewModel: (data: {
    ...
    <div>
      <Button
        onClick={wxr.bindEventToCommand(
          data.viewModel,
          x => data.createContext,
      ...
      <Components.ModalDialogView
        ...
        modalBody={() => (
          <FormControl
            type="text"
            defaultValue={data.viewModel.context.value}
          />
        )}
  ...
  TabsViewModel: (
    viewModel: Components.TabsViewModel<any>,
    componentRoute: string,
  ) => {
    if (componentRoute === 'StaticTabs') {
      return (
        <Components.TabsView viewModel={viewModel} id="demo-tabs">
          <Tab title="First Static Tab">
            <Well style={{ margin: 0 }}>Content 1</Well>
          </Tab>
          <Tab title="Second Static Tab">
            <Well style={{ margin: 0 }}>Content 2</Well>
          </Tab>
        </Components.TabsView>
      );
    } else {
      ...
      const template = new Components.TabRenderTemplate<any>(
        (x, i) => `Tab ${x}`,
        (x, i, vm) => (
          <Button
            style={{ width: '100%', marginTop: 10 }}
            onClick={() => {
              vm.removeTab.execute(i);
            }}
          >
            {`Close Tab ${x}`}
          </Button>
  ...
  CommonPanel: () => (
    ...
    >
      ...
      <Button
        onClick={() => Alert.create('Button Clicked', 'Common Panel Demo')}
      >
        Or Even a Button
      </Button>
    </Components.CommonPanel>
  ...
  DataGridViewModel: (
    viewModel: Components.DataGridViewModel<{}>,
    componentRoute: string,
  ) => {
    switch (componentRoute) {
      case 'DataGrid':
        return (
          ...
          >
            <Components.GridViewColumn
              field="id"
              cellTooltipTemplate={(x: SampleData) => `Item ${x.id}`}
            />
            <Components.GridViewColumn
              id="cat"
              header="Category"
              cellTemplate={(x: SampleData) => x.cat}
              headerTooltipTemplate="Simple Header Tooltip"
            />
            <Components.GridViewColumn
              field="requiredBy"
              header="Required By"
              cellTooltipTemplate={(x: SampleData) => (
                <Components.ContentTooltip
                  content={`Popover Content for ${x.name}`}
                  title="Fancy Tooltip"
                />
              )}
            />
      ...
      case 'DataGridAutoCol':
        return <Components.DataGridView viewModel={viewModel} pager />;
      ...
      case 'DataGridPager':
        ...
        return <Components.DataGridView viewModel={viewModel} pager={pager} />;
      case 'DataGridList':
        return (
          <Components.DataGridView
            viewModel={viewModel}
  ...
  AsyncDataGridViewModel: (
    viewModel: Components.AsyncDataGridViewModel<{}>,
    componentRoute: string,
  ) => {
    switch (componentRoute) {
      case 'DataGridAsync':
  ...
  ItemListPanelViewModel: (
    viewModel: Components.ItemListPanelViewModel<{}>,
    componentRoute: string,
  ) => {
    switch (componentRoute) {
      case 'ItemListPanel':
        return (
          <Components.ItemListPanelView
            ...
            footerContent={
              <Components.CountFooterContent
                count={viewModel.projectedCount}
                suffix="Things"
              />
            }
          >
  ...
  TreeItemListPanelViewModel: (
    viewModel: Components.TreeItemListPanelViewModel<{}>,
  ) => (
    <Components.ItemListPanelView
      viewModel={viewModel}
      collapsible
  ...
  AsyncItemListPanelViewModel: (
    viewModel: Components.AsyncItemListPanelViewModel<{}>,
  ) => (
    <Components.ItemListPanelView
      viewModel={viewModel}
      collapsible
  ...
  AsyncTreeItemListPanelViewModel: (
    viewModel: Components.AsyncTreeItemListPanelViewModel<{}>,
  ) => (
    <Components.ItemListPanelView
      viewModel={viewModel}
      collapsible
  ...
  InlineEditViewModel: (
    viewModel: Components.InlineEditViewModel<any>,
    componentRoute: string,
  ) => {
    if (componentRoute === 'InlineEditObject') {
      return (
        <Components.InlineEditView
          style={{ margin: 0 }}
          viewModel={viewModel}
          inputType="number"
          template={x => `${x.rank} of 10`}
          converter={x => Number(x)}
          keyboard
          clickToEdit
          valueGetter={(x: Property<any>) => x.value.rank}
          valueSetter={(v, p: Property<any>) => (p.value.rank = v)}
        />
      );
    } else {
      return (
  ...
  Help: (c, cr, r) => {
    ...
    return (
      <div>
        ...
        {helpItem(
          'A todo list example in the sidebar menu',
          100,
          350,
          'arrow-left',
          'left',
        ...
        {helpItem(
          'Some webrx-react component demos',
          10,
          690,
          'arrow-left',
          'left',
